...
public class Kiosk {
    ...
    private Menu menuItem1 = new Menu("김밥", 1000);
    private Menu menuItem2 = new Menu("계란 김밥", 1500);
    private Menu menuItem3 = new Menu("충무 김밥", 1000);
    private Menu menuItem4 = new Menu("떡볶이", 2000);
    ...
    public void printOrderPriceMessage(Menu menu, int count) {
        System.out.println("[안내] 주문하신 상품은 : " + menu.getName() + "의 총 주문 갯수는 : " + count + "개 입니다.");
        System.out.println("[안내] 주문하신 메뉴의 총 금액은 " + calculateOrderPrice(menu, count) + "원 입니다.");
